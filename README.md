This simple rotation script makes doors rotate at any angle in any direction. To use it, please import the scripts into Unity and then attach them to the same or separate objects.
